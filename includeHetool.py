...
class Hetool:
    ...
    # To add new attribute prototypes, go to the src\geometry\attributes\attribprototype.json
    ...
    #                  about this class see src\geometry\point;
    #           - _seg: Segment class object (class Segment); For more information
    #                   about this class see src\geometry\segments\Line or
    #                   src\geometry\segments\Polyline;
    #           - _patch: Patch class object (class Patch);For more information
    #                     about this class see src\geometry\Patch;
    ...
    # function in the directory src\geometry\attributes\attribsymbols.
    ...
    def setNumberOfSubdivisions(_number, _ratio):
    ...
    # about this class see src\geometry\segments\line and src\geometry\segments\polilyne.
    def getSegments():
